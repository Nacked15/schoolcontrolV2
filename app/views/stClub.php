...
<div class="row">
   ...
   <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-2">
      <ul class="nav nav-justified vx">    
         <li role="presentation" class="state-on"><a class="sts" href="?menu_ad=alumnos&registro=Club">ENGLISH CLUB <span class="badge"><?php stCount('1'); ?></span></a></li>
         ...
         <li role="presentation"><a class="sts" href="?menu_ad=alumnos&registro=Adultos">ADULTOS <span class="badge"><?php stCount('4'); ?></span></a></li>
...
<section id="club" class="well">
      ...
      <a href="#" data-toggle='tooltip' data-placement='bottom' data-trigger='hover' title='Pulse para cambio de grupo multiple' id="showChecks" class="label label-primary">Cambiar Grupo <span class="glyphicon glyphicon-share-alt" aria-hidden="true"></span></a>
