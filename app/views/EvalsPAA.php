						...
						<tbody>
							<tr>
								<td>
									...
									<div>
										<input type="text" name="nombre" value="<?= $alumno['name_e']; ?>" class="form-control" placeholder="Name Somebody">
									</div>
								</td>
								<td>
									<label>Fecha:</label>
									<div>
										<input type="date" value="<?= $alumno['date_eval']; ?>" name="fecha" class="form-control">
									</div>
								</td>
							</tr>
						</tbody>
							...
							<tbody>
								<tr>
									<td>
										<label>Nombre/Firma:</label>
										<div>
											<input type="text" value="<?= $alumno['name_e']; ?>" name="nombre" class="form-control" placeholder="Name Somebody">
										</div>
									</td>
									<td>
										<label>Fecha:</label>
