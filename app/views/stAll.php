...
<div class="row">
   ...
   <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-2">
      <ul class="nav nav-justified vx">
         ...
         <li role="presentation" class="state-on"><a class="sts" href="?menu_ad=alumnos&registro=allStudents"><strong class="text-dark">TODOS <span class="badge"><?php stTotal(); ?></span></strong></a></li>
      </ul>
   </div>
</div>
