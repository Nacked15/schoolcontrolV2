...
<div class="row">
   ...
   <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-2">
      <ul class="nav nav-justified vx">    
         <li role="presentation"><a class="sts" href="?menu_p=alumnos&element=Club">ENGLISH CLUB <span class="badge"><?php teacherStCount('1'); ?></span></a></li>
         ...
         <li role="presentation"><a class="sts" href="?menu_p=alumnos&element=Adultos">ADULTOS <span class="badge"><?php teacherStCount('4'); ?></span></a></li>
         <li role="presentation" class="state-on"><a class="sts" href="?menu_p=alumnos&element=allStudents"><strong class="text-dark">TODOS <span class="badge"><?php TeacherStTotal(); ?></span></strong></a></li>
      </ul>
   </div>
</div>
