...
<div class="row">
   ...
   <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-2">
      <ul class="nav nav-justified vx">    
         ...
         <li role="presentation" class="state-on"><a class="sts" href="?menu_p=notasCapturar&evaluation=evalPrimary">PRIMARY <span class="badge"><?php teacherStCount('2'); ?></span></a></li>
