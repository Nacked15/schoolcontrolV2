...
<div class="row">
   ...
   <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-2">
      <ul class="nav nav-justified vx">    
         ...
         <li role="presentation" class="state-on"><a class="sts" href="?menu_p=notasCapturar&evaluation=evalAdolescentes">ADOLESCENTES <span class="badge"><?php teacherStCount('3'); ?></span></a></li>
         <li role="presentation" id="pestana4"><a class="sts" href="?menu_p=notasCapturar&evaluation=evalAdultos">ADULTOS <span class="badge"><?php teacherStCount('4'); ?></span></a></li>
      </ul>
   </div>
</div>
