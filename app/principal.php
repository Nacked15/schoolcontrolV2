					...
					<div class="well">
							<div class="page-header">
								<div class="pull-right form-inline">
									<div class="btn-group">
										<button class="btn btn-sm btn-success" data-calendar-nav="prev"><< Ant.</button>
										<button class="btn btn-sm" id="hoyday" data-calendar-nav="today">Hoy</button>
								...
								<div class="col-sm-3">
										...
										<div class="form-group">
										   <div class="checkbox-material col-sm-10">
										      <!-- <label class="checkbox-horizontal checkbox-material">
										         <input type="checkbox" value="#events-modal" id="events-in-modal"> Abrir evento en un Modal
										      </label> -->
										      ...
										      <!-- <label class="checkbox-horizontal">
										         <input type="checkbox" id="show_wbn" checked> Mostrar numero de semana
										      </label> -->
										   </div>
										</div>
								</div>
